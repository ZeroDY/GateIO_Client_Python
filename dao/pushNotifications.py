...
from config import jpush_app_key, jpush_master_secret
import jpush

_jpush = jpush.JPush(jpush_app_key, jpush_master_secret)
_jpush.set_logging("DEBUG")

def all(alert='ZZBarometer - Hello, World! - 🚀🚀🚀🚀🚀'):
    push = _jpush.create_push()
    push.audience = jpush.all_
    ios = jpush.ios(alert=alert, sound="a.caf", extras={'className':'ViewController'})
    push.notification = jpush.notification(alert="Hello, JPush!", android=None, ios=ios)
